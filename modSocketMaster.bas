...
If Not m_blnInitiated Then
    ...
    If lngResult = 0 Then
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Winsock service initiated"
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
    Else
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "ERROR trying to initiate winsock service"
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
...
If m_blnInitiated And m_lngSocksQuantity = 0 Then
    ...
    Else
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Winsock service finalized"
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
    End If
...
Else
    ...
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Created winsock message window " & m_lngWindowHandle
   frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
End If
End Function
...
If m_lngWindowHandle = 0 Then
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "WARNING lngWindowHandle is ZERO"
   frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
    Exit Function
End If
...
Else
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Destroyed winsock message window " & m_lngWindowHandle
    frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
    m_lngWindowHandle = 0
End If
...
If m_colSocketsInst Is Nothing Then
    ...
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Created socket collection"
   frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
...
If blnEvents Then
    ...
    If lngResult = SOCKET_ERROR Then
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "ERROR trying to register events from socket " & lngSocket
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
        lngErrorCode = Err.LastDllError
        Err.Raise lngErrorCode, "modSocketMaster.RegisterSocket", GetErrorDescription(lngErrorCode)
    Else
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Registered events from socket " & lngSocket
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
    End If
End If
...
If m_colSocketsInst.Count = 0 Then
    ...
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Destroyed socket collection"
   frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
End If
End Sub
...
If m_colAcceptList Is Nothing Then
    ...
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Created accept collection"
   frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
End If
...
If m_colAcceptList.Count = 0 Then
    ...
    frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Destroyed accept collection"
   frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
End If
End Sub
...
Const MOD_USER As String = "user32"                         'Location of the SetWindowLong & CallWindowProc functions
  ...
  frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Subclass memory allocated at: " & nAddrSubclass
 frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
...
Private Sub Subclass_Terminate()
  ...
  frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "OK Freed subclass memory at: " & nAddrSubclass
 frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
  nAddrSubclass = 0
...
For Count = 1 To lngMsgCntA
    ...
    Case -1
        ...
        Exit Sub
    Case lngAsync
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "WARNING: Async already registered!"
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
        Exit Sub
    End Select
Next Count
...
For Count = 1 To lngMsgCntB
    ...
    Case -1
        ...
        Exit Sub
    Case lngSocket
        frmSendMail.txtStatus = frmSendMail.txtStatus & vbNewLine & "WARNING: Socket already registered!"
       frmSendMail.txtStatus.SelStart = Len(frmSendMail.txtStatus.Text)
        Exit Sub
    End Select
Next Count
